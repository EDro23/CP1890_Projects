...
def display_lineup(players):
    if players == None:
        ...
        for i, player in enumerate(players):
            print(f'{i+1:<3d}{player.first_name.ljust(1)} {player.last_name.ljust(29)} {player.position.rjust(6)}\t{str(player.at_bats).rjust(6)} {str(player.hits).rjust(6)}\t\t{player.battingAvg:.3f}')
        print()
