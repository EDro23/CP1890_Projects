...
button = ttk.Button(frame, text="Hi, I'm a cool button", command=clicked_button1)
button.grid(column=0, row=2, sticky=tk.E)
#button.pack()
button2 = ttk.Button(frame, text="Exit", command=clicked_button2)
button2.grid(column=1, row=2, sticky=tk.E)
#button2.pack()
